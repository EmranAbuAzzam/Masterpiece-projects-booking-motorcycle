...
@section('content')
    ...
    <!-- Page Header Start -->
    <div class="container-fluid page-header mb-5 p-0" style="background-image: url('https://www.wheelsmotorcycles.co.uk/i/?item_id=182&item_type=banner&item_size=banner&hash=8581d2d490c738e07ab457e2dcf906ba');">
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h6 class="section-title text-center text-primary text-uppercase">motorcycle Booking</h6>
                <h1 class="mb-5">Book This motorcycle</h1>
            </div>
            <div class="row g-5">
                <div class="col-lg-6">
                    ...
                    {{-- <img width="100%" height="100%" class=" rounded w-75 wow zoomIn" data-wow-delay="0.1s"
                        src="{{ asset('images/' . $motorcycle->motorcycle_image) }}" > --}}
                        <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
                            <div class="carousel-inner">
                              <div class="carousel-item active">
                                <img src="{{ asset('images/' . $motorcycle->motorcycle_image) }}" class="d-block w-100" alt="...">
                              </div>
                              <div class="carousel-item">
                                <img src="{{ asset('images/' . $motorcycle->motorcycle_image1) }}" class="d-block w-100" alt="...">
                              </div>
                              <div class="carousel-item">
                                <img src="{{ asset('images/' . $motorcycle->motorcycle_image2) }}" class="d-block w-100" alt="...">
                              </div>
                            </div>
                ...
                <div class="col-lg-6">
                    <div class="wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <form action="{{ route('motorcycle.book.confirm', $motorcycle->id) }}" method="post"
