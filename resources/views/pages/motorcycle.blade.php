...
@section('content')
    ...
    <!-- Page Header Start -->
    <div class="container-fluid page-header mb-5 p-0" style="background-image: url(img/photo-1506424482693-1f123321fa53.jfif);">
        <div class="container-fluid page-header-inner py-5">
            <div class="container text-center pb-5">
                <h1 class="display-3 text-white mb-3 animated slideInDown">motorcycle</h1>
            ...
            <div class="row g-4">
                ...
                @foreach ($motorcycle as $motorcycle)
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="motorcycle-item shadow rounded overflow-hidden">
                            <div class="position-relative">
                                <img class="img-fluid" src="/images/{{ $motorcycle->motorcycle_image }}" alt="">
                                <small
                                    class="position-absolute start-0 top-100 translate-middle-y bg-primary text-white rounded py-1 px-3 ms-4">{{ $motorcycle->motorcycle_price }}/Per day</small>
                            </div>
                            <div class="p-4 mt-2">
                                <div class="d-flex justify-content-between mb-3">
                                    <h5 class="mb-0">motorcycle Number : ( {{ $motorcycle->id }} )<br><span ><h6 class="text-primary" >- {{ $motorcycle->cat_name }} </h6></span></h5>
                                    <div class="ps-2">
                                ...
                                <div class="d-flex mb-3">
                                    <small class="border-end me-3 pe-3"><i
                                            class="fa fa-motorcycle text-primary me-2"></i>{{ $motorcycle->num_of_motorcycle }} motorcycle</small>

                                    {{-- <small><i class="fa fa-engine text-primary me-2"></i>Wifi</small> --}}
                                </div>
                                <p class="text-body mb-3">{{ $motorcycle->motorcycle_description }}</p>
                                <div class="d-flex justify-content-end">
                                    <a class="btn btn-sm btn-dark rounded py-2 px-4"
                                        href="{{ route('motorcycle.book', $motorcycle->id) }}">Book Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
